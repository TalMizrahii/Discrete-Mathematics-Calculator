 ...
 * The "Nor" class.
 *
 * <p>contains all the method connected to a logical 'Nor'.
...
public class Nor extends BinaryExpression implements Expression {
    ...
    /**
     * a constructor for "Nor", using the binaryExpression constructor.
     *
    ...
    /**
     * converting the expression from "Nor" expression to a "Nand" expression.
     *
    ...
    /**
     * recusivley keeping to nordify the expressions.
     *
    ...
    public Expression simplify() {
        ...
        if (getExpression2().simplify().toString().equals("T") || getExpression1().simplify().toString().equals("T")) {
